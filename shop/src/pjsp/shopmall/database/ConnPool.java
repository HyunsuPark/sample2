/**
Connection Pool Class by Yang Hooe Suk
*/
package pjsp.shopmall.database;
import java.io.File;
...
public class ConnPool {
	...
	private String path = "/jsp/prop/db.properties";	
	public ConnPool(){
	}
	...
	public void setPath(String path) {
		if(path == null) return; //if null use default!
		this.path = path;
	}
	...
	////////////////// Utility Methods ////////////////////
	private synchronized Connection getConnection(long wait_time)
	throws SQLException {
