...
/**
 * Servlet implementation class kyosuSearchAjaxServlet1
 */
public class KyosuSearchAjaxServlet1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<KyosuSearchDto> lists = manager.getKyosuSearch1();
