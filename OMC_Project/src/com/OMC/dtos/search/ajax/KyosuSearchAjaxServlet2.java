...
/**
 * Servlet implementation class kyosuSearchAjaxServlet2
 */
public class KyosuSearchAjaxServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KyosuSearchAjaxServlet2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<KyosuSearchDto> lists = manager.getKyosuSearch2(subject);
