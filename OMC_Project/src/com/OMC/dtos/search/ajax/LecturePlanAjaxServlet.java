...
/**
 * Servlet implementation class LecturePlanAjaxServlet
 */
public class LecturePlanAjaxServlet extends HttpServlet {
	 ...
	 */
	  public void doPost(HttpServletRequest request,
			...
			List<LecturePlanDto> lists = manager.getLecturePlan(curi_num1, curi_nm1, kor_nm1,semester);
