...
import com.OMC.daos.SearchService;
import com.OMC.dtos.search.LecturePlanDto;

/**
 * Servlet implementation class LecturePlanAjaxServlet4
 */
public class LecturePlanAjaxServlet4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LecturePlanAjaxServlet4() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<LecturePlanDto> lists = manager.getLecturePlan4(curi_nm1,semester);
