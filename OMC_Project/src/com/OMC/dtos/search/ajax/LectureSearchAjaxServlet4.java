...
/**
 * Servlet implementation class LectureSearchAjaxServlet4
 */
public class LectureSearchAjaxServlet4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LectureSearchAjaxServlet4() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<LectureSearchDto> lists = manager.getLectureSearch3();
