...
/**
 * Servlet implementation class LectureSearchAjaxServlet
 */
public class LectureSearchAjaxServlet extends HttpServlet {
	 ...
	 */
	  public void doPost(HttpServletRequest request,
			...
			System.out.println(request.getParameter("curi_num"));
			String curi_num=request.getParameter("curi_num").trim();
			System.out.println("1: curi_num=  "+curi_num);
			List<LectureSearchDto> lists = manager.getLectureSearch(curi_num);
