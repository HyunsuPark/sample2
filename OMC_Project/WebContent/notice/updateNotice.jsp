...
if(obj != null){
	...
	<%
	response.sendRedirect("menu_control.jsp?command=main");
}
%>
<title>update</title>
</head>
...
<input type="hidden" name="command" value="updatednotice">
<input type="hidden" name="seq" value="<%=dto.getSeq()%>">
	<table border="1" width="65%" >
		<tr>
			<td align="center" width="">제목</td>
			<td><input name="title" maxlength="50" size="50" value="<%=dto.getTitle()%>"></td>
		</tr>
		<tr >
			<td align="center">내용</td>
			<td><textarea name="content" cols="50" rows="20"><%=dto.getContent()%></textarea></td>
		</tr>
		<tr>
			<td colspan="2"><input type="button" value="뒤로가기" onclick="back()">
			<input type="button" onclick="submit_form()"value="수정"></td>
		</tr>
	</table>
</form>
</body>
