  ...
  BubbleChart = (function() {
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      if (element.className.baseVal === 'all') {
        ...
        content = ("<span class=\"name\">일반:</span><span class=\"value\">" + (addCommas(values[2])) + "명 (") + rate1 + "%)</span><br/>";
        content += ("<span class=\"name\">저소득:</span><span class=\"value\">" + (addCommas(values[1])) + "명 (") + rate2 + "%)</span><br/>";
        content += ("<span class=\"name\">기초생활수급권자:</span><span class=\"value\">" + (addCommas(values[0])) + "명 (") + rate3 + "%)</span>";
      }
